                    ...
                    <div class="col-lg-6 col-12">
                        <div class="card ">
                            <div class="card-body rounded" >
                                <h4 class="card-title"><i class="mdi mdi-pencil"></i> การเพิ่มขึ้นของข้อมูลอย่างมีนัยสำคัญ</h4>
                                <div class="img-thumbnail">
                                    <img src="http://localhost/no_school/assets/images/background/img4.jpg" class="img-fluid">
                                </div>
                                
                                <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Blanditiis obcaecati, animi a rerum id amet qui tempore aut temporibus quis, totam quam provident reprehenderit commodi, mollitia exercitationem possimus. Quis, cumque.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <div class="card ">
                            <div class="card-body rounded" >
                                ...
                                <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci ipsum reprehenderit tempore perspiciatis doloremque unde dolorem. Porro consequatur repellendus praesentium ea excepturi obcaecati incidunt sunt hic! Rem quia officia autem.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php 
                                    ...
                                    $j .= 'consectet lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsumconsectet lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum';

                                ?>
                                <table class="table table-bordered">
                                    <tr>
                                        <td class="text-wrap"><?php echo $j; ?></td>
                                    </tr>
                                </table>
                            </div>
